...
//[UHDL]Key Start [md5:71b03395a32abfe96de4936228d621a8]
//Version Control Hash: 3accddf64b1dd03abeb9b0b3e5a7ba44
//Content Hash: ac5ee9bb34201548faf9cc5b60f3c5b6
//Parameter Hash: d41d8cd98f00b204e9800998ecf8427e
//[UHDL]Key End [md5:71b03395a32abfe96de4936228d621a8]
...
//[UHDL]Content Start [md5:ac5ee9bb34201548faf9cc5b60f3c5b6]
module DArbDual_node_A0 (
	...
	input  [359:0] in1_req_pld    ,
	input  [3:0]   in0_req_mst_id ,
	input  [3:0]   in1_req_mst_id ,
	input  [3:0]   in0_req_slv_id ,
	input  [3:0]   in1_req_slv_id ,
	output         in0_ack_vld    ,
	output         in1_ack_vld    ,
	input          in0_ack_rdy    ,
	input          in1_ack_rdy    ,
	...
	output [9:0]   in1_ack_pld    ,
	output [3:0]   in0_ack_mst_id ,
	output [3:0]   in1_ack_mst_id ,
	output [3:0]   in0_ack_slv_id ,
	output [3:0]   in1_ack_slv_id ,
	output         out0_req_vld   ,
	input          out0_req_rdy   ,
	...
	wire         arb_in0_tail   ;
	wire         arb_in1_tail   ;
	wire [359:0] arb_in0_pld    ;
	wire [359:0] arb_in1_pld    ;
	...
	wire         dec_out0_tail  ;
	wire         dec_out1_tail  ;
	wire [9:0]   dec_out0_pld   ;
	wire [9:0]   dec_out1_pld   ;
	...
	wire         dec_in0_head   ;
	wire         dec_in0_tail   ;
	wire [9:0]   dec_in0_pld    ;
	wire [3:0]   dec_in0_mst_id ;
	wire [3:0]   dec_in0_slv_id ;
	assign in0_req_rdy = arb_in0_rdy;
	
	assign in1_req_rdy = arb_in1_rdy;
	
	assign in0_ack_vld = dec_out0_vld;
	
	assign in1_ack_vld = dec_out1_vld;
	
	assign in0_ack_head = dec_out0_head;
	
	assign in1_ack_head = dec_out1_head;
	
	assign in0_ack_tail = dec_out0_tail;
	
	assign in1_ack_tail = dec_out1_tail;
	
	assign in0_ack_pld = dec_out0_pld;
	
	assign in1_ack_pld = dec_out1_pld;
	
	assign in0_ack_mst_id = dec_out0_mst_id;
	
	assign in1_ack_mst_id = dec_out1_mst_id;
	
	assign in0_ack_slv_id = dec_out0_slv_id;
	
	assign in1_ack_slv_id = dec_out1_slv_id;
	
	assign out0_req_vld = arb_out0_vld;
	
	assign out0_req_head = arb_out0_head;
	
	assign out0_req_tail = arb_out0_tail;
	
	assign out0_req_pld = arb_out0_pld;
	
	assign out0_req_mst_id = arb_out0_mst_id;
	
	assign out0_req_slv_id = arb_out0_slv_id;
	
	assign out0_ack_rdy = dec_in0_rdy;
	
	assign arb_in0_vld = in0_req_vld;
	
	assign arb_in1_vld = in1_req_vld;
	
	assign arb_in0_head = in0_req_head;
	
	assign arb_in1_head = in1_req_head;
	
	assign arb_in0_tail = in0_req_tail;
	
	assign arb_in1_tail = in1_req_tail;
	
	assign arb_in0_pld = in0_req_pld;
	
	assign arb_in1_pld = in1_req_pld;
	
	assign arb_in0_mst_id = in0_req_mst_id;
	
	assign arb_in1_mst_id = in1_req_mst_id;
	
	assign arb_in0_slv_id = in0_req_slv_id;
	
	assign arb_in1_slv_id = in1_req_slv_id;
	
	assign arb_out0_rdy = out0_req_rdy;
	
	assign dec_out0_rdy = in0_ack_rdy;
	
	assign dec_out1_rdy = in1_ack_rdy;
	
	assign dec_in0_vld = out0_ack_vld;
	
	assign dec_in0_head = out0_ack_head;
	
	assign dec_in0_tail = out0_ack_tail;
	
	assign dec_in0_pld = out0_ack_pld;
	
	assign dec_in0_mst_id = out0_ack_mst_id;
	
	assign dec_in0_slv_id = out0_ack_slv_id;
	
	DArb_node_A0_pld_width_360_id_type_slv arb (
		.clk(arb_clk),
		.rst_n(arb_rst_n),
		.in0_vld(arb_in0_vld),
		.in1_vld(arb_in1_vld),
	...
	DDec_node_A0_pld_width_10_id_type_slv dec (
...
//[UHDL]Content End [md5:ac5ee9bb34201548faf9cc5b60f3c5b6]
