...
//[UHDL]Key Start [md5:1741312557ced539f5b1e841c26efb3a]
//Version Control Hash: 3accddf64b1dd03abeb9b0b3e5a7ba44
//Content Hash: f54c5975ace8886e234fd0f89299a5dc
//Parameter Hash: d41d8cd98f00b204e9800998ecf8427e
//[UHDL]Key End [md5:1741312557ced539f5b1e841c26efb3a]
...
//[UHDL]Content Start [md5:f54c5975ace8886e234fd0f89299a5dc]
module DArbDual_node_A0 (
	input         clk              ,
	input         rst_n            ,
	...
	input  [3:0]  in0_w_req_gt_id  ,
	input  [7:0]  in0_w_req_xn_id  ,
	input         in1_w_req_vld    ,
	output        in1_w_req_dy     ,
	input         in1_w_req_head   ,
	input         in1_w_req_ail    ,
	input  [99:0] in1_w_req_pld    ,
	input  [3:0]  in1_w_req_src_id ,
	input  [3:0]  in1_w_req_gt_id  ,
	input  [7:0]  in1_w_req_xn_id  ,
	input         in0_r_req_vld    ,
	output        in0_r_req_dy     ,
	...
	input  [3:0]  in0_r_req_gt_id  ,
	input  [7:0]  in0_r_req_xn_id  ,
	input         in1_r_req_vld    ,
	output        in1_r_req_dy     ,
	input         in1_r_req_head   ,
	input         in1_r_req_ail    ,
	input  [63:0] in1_r_req_pld    ,
	input  [3:0]  in1_r_req_src_id ,
	input  [3:0]  in1_r_req_gt_id  ,
	input  [7:0]  in1_r_req_xn_id  ,
	...
	output [3:0]  in0_w_ack_gt_id  ,
	output [7:0]  in0_w_ack_xn_id  ,
	output        in1_w_ack_vld    ,
	input         in1_w_ack_rdy    ,
	output        in1_w_ack_head   ,
	output        in1_w_ack_il     ,
	output [1:0]  in1_w_ack_pld    ,
	output [3:0]  in1_w_ack_src_id ,
	output [3:0]  in1_w_ack_gt_id  ,
	output [7:0]  in1_w_ack_xn_id  ,
	...
	output [3:0]  in0_r_ack_gt_id  ,
	output [7:0]  in0_r_ack_xn_id  ,
	output        in1_r_ack_vld    ,
	input         in1_r_ack_dy     ,
	output        in1_r_ack_head   ,
	output        in1_r_ack_il     ,
	output [34:0] in1_r_ack_pld    ,
	output [3:0]  in1_r_ack_src_id ,
	output [3:0]  in1_r_ack_gt_id  ,
	output [7:0]  in1_r_ack_xn_id  );
	wire        warb_clk        ;
	wire        warb_rst_n      ;
	wire        warb_out_vld    ;
	wire        warb_out_rdy    ;
	...
	wire        rdec_out1_head  ;
	wire        rdec_out1_tail  ;
	wire [34:0] rdec_out1_pld   ;
	wire [3:0]  rdec_out1_src_id;
	wire [3:0]  rdec_out1_tgt_id;
	wire [7:0]  rdec_out1_txn_id;
	assign out0_w_req_vld = warb_out_vld;
	
	assign out0_w_req_head = warb_out_head;
	
	assign out0_w_req_tail = warb_out_tail;
	
	assign out0_w_req_pld = warb_out_pld;
	
	assign out0_w_req_src_id = warb_out_src_id;
	
	assign out0_w_req_tgt_id = warb_out_tgt_id;
	
	assign out0_w_req_txn_id = warb_out_txn_id;
	
	assign out0_r_req_vld = rarb_out_vld;
	
	assign out0_r_req_head = rarb_out_head;
	
	assign out0_r_req_tail = rarb_out_tail;
	
	assign out0_r_req_pld = rarb_out_pld;
	
	assign out0_r_req_src_id = rarb_out_src_id;
	
	assign out0_r_req_tgt_id = rarb_out_tgt_id;
	
	assign out0_r_req_txn_id = rarb_out_txn_id;
	
	assign out0_w_ack_rdy = wdec_din_rdy;
	
	assign out0_r_ack_rdy = rdec_din_rdy;
	
	assign in0_w_req_dy = warb_in0_rdy;
	
	assign in1_w_req_dy = warb_in1_rdy;
	
	assign in0_r_req_dy = rarb_in0_rdy;
	
	assign in1_r_req_dy = rarb_in1_rdy;
	
	assign in0_w_ack_vld = wdec_out0_vld;
	
	assign in0_w_ack_head = wdec_out0_head;
	
	assign in0_w_ack_il = wdec_out0_tail;
	
	assign in0_w_ack_pld = wdec_out0_pld;
	
	assign in0_w_ack_src_id = wdec_out0_src_id;
	
	assign in0_w_ack_gt_id = wdec_out0_tgt_id;
	
	assign in0_w_ack_xn_id = wdec_out0_txn_id;
	
	assign in1_w_ack_vld = wdec_out1_vld;
	
	assign in1_w_ack_head = wdec_out1_head;
	
	assign in1_w_ack_il = wdec_out1_tail;
	
	assign in1_w_ack_pld = wdec_out1_pld;
	
	assign in1_w_ack_src_id = wdec_out1_src_id;
	
	assign in1_w_ack_gt_id = wdec_out1_tgt_id;
	
	assign in1_w_ack_xn_id = wdec_out1_txn_id;
	
	assign in0_r_ack_vld = rdec_out0_vld;
	
	assign in0_r_ack_head = rdec_out0_head;
	
	assign in0_r_ack_il = rdec_out0_tail;
	
	assign in0_r_ack_pld = rdec_out0_pld;
	
	assign in0_r_ack_src_id = rdec_out0_src_id;
	
	assign in0_r_ack_gt_id = rdec_out0_tgt_id;
	
	assign in0_r_ack_xn_id = rdec_out0_txn_id;
	
	assign in1_r_ack_vld = rdec_out1_vld;
	
	assign in1_r_ack_head = rdec_out1_head;
	
	assign in1_r_ack_il = rdec_out1_tail;
	
	assign in1_r_ack_pld = rdec_out1_pld;
	
	assign in1_r_ack_src_id = rdec_out1_src_id;
	
	assign in1_r_ack_gt_id = rdec_out1_tgt_id;
	
	assign in1_r_ack_xn_id = rdec_out1_txn_id;
	
	assign warb_out_rdy = out0_w_req_rdy;
	
	assign warb_in0_vld = in0_w_req_vld;
	
	assign warb_in0_head = in0_w_req_head;
	
	assign warb_in0_ail = in0_w_req_ail;
	
	assign warb_in0_pld = in0_w_req_pld;
	
	assign warb_in0_src_id = in0_w_req_src_id;
	
	assign warb_in0_gt_id = in0_w_req_gt_id;
	
	assign warb_in0_xn_id = in0_w_req_xn_id;
	
	assign warb_in1_vld = in1_w_req_vld;
	
	assign warb_in1_head = in1_w_req_head;
	
	assign warb_in1_ail = in1_w_req_ail;
	
	assign warb_in1_pld = in1_w_req_pld;
	
	assign warb_in1_src_id = in1_w_req_src_id;
	
	assign warb_in1_gt_id = in1_w_req_gt_id;
	
	assign warb_in1_xn_id = in1_w_req_xn_id;
	
	assign wdec_din_vld = out0_w_ack_vld;
	
	assign wdec_din_head = out0_w_ack_head;
	
	assign wdec_din_tail = out0_w_ack_tail;
	
	assign wdec_din_pld = out0_w_ack_pld;
	
	assign wdec_din_src_id = out0_w_ack_src_id;
	
	assign wdec_din_tgt_id = out0_w_ack_tgt_id;
	
	assign wdec_din_txn_id = out0_w_ack_txn_id;
	
	assign wdec_out0_rdy = in0_w_ack_rdy;
	
	assign wdec_out1_rdy = in1_w_ack_rdy;
	
	assign rarb_out_rdy = out0_r_req_rdy;
	
	assign rarb_in0_vld = in0_r_req_vld;
	
	assign rarb_in0_head = in0_r_req_head;
	
	assign rarb_in0_ail = in0_r_req_ail;
	
	assign rarb_in0_pld = in0_r_req_pld;
	
	assign rarb_in0_src_id = in0_r_req_src_id;
	
	assign rarb_in0_gt_id = in0_r_req_gt_id;
	
	assign rarb_in0_xn_id = in0_r_req_xn_id;
	
	assign rarb_in1_vld = in1_r_req_vld;
	
	assign rarb_in1_head = in1_r_req_head;
	
	assign rarb_in1_ail = in1_r_req_ail;
	
	assign rarb_in1_pld = in1_r_req_pld;
	
	assign rarb_in1_src_id = in1_r_req_src_id;
	
	assign rarb_in1_gt_id = in1_r_req_gt_id;
	
	assign rarb_in1_xn_id = in1_r_req_xn_id;
	
	assign rdec_din_vld = out0_r_ack_vld;
	
	assign rdec_din_head = out0_r_ack_head;
	
	assign rdec_din_tail = out0_r_ack_tail;
	
	assign rdec_din_pld = out0_r_ack_pld;
	
	assign rdec_din_src_id = out0_r_ack_src_id;
	
	assign rdec_din_tgt_id = out0_r_ack_tgt_id;
	
	assign rdec_din_txn_id = out0_r_ack_txn_id;
	
	assign rdec_out0_rdy = in0_r_ack_dy;
	
	assign rdec_out1_rdy = in1_r_ack_dy;
	
	DArb_node_A0_pld_width_100_id_type_src warb (
		.clk(warb_clk),
		.rst_n(warb_rst_n),
	...
	DDec_node_A0_pld_width_2_id_type_src wdec (
	...
	DArb_node_A0_pld_width_64_id_type_src rarb (
		.clk(rarb_clk),
		.rst_n(rarb_rst_n),
	...
	DDec_node_A0_pld_width_35_id_type_src rdec (
...
//[UHDL]Content End [md5:f54c5975ace8886e234fd0f89299a5dc]
